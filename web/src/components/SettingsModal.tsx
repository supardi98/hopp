      ...
      <div className="relative w-full max-w-lg glass-panel rounded-3xl p-6 border border-slate-700/80 shadow-2xl space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-xs font-semibold text-slate-200">Auto-sync Clipboard</span>
                <p className="text-[11px] text-slate-400">Otomatis sinkronkan saat menyalin (Ctrl+C)</p>
              </div>
              <input
                type="checkbox"
