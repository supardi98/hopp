    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/95 overflow-y-auto">
      <div className="relative w-full max-w-lg glass-panel rounded-3xl p-5 sm:p-6 border border-slate-700/80 shadow-2xl flex flex-col max-h-[90vh] my-auto">
        ...
        <div className="overflow-y-auto flex-1 space-y-4 py-4 pr-1 text-xs text-slate-300">
          ...
          <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900/90 border border-slate-800 flex flex-col sm:flex-row items-center gap-4">
            <div className="w-24 h-24 sm:w-28 sm:h-28 p-2 bg-white rounded-xl flex items-center justify-center shadow-inner shrink-0">
          ...
          {/* Manual Pairing Form */}
          <form id="pairing-form" onSubmit={handlePairSubmit} className="space-y-4">
        ...
        <div className="pt-3 border-t border-slate-800 shrink-0">
          <button
            type="submit"
            form="pairing-form"
            className="w-full py-2.5 px-4 text-xs font-bold text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 rounded-xl shadow-lg shadow-indigo-600/30 transition-all flex items-center justify-center space-x-2"
          >
